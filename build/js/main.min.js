...
var _navigationToggle = require("./modules/custom/navigation-toggle");
var _video = require("./modules/custom/video");
var _audio = require("./modules/custom/audio");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _navigationToggle.addNavigationToggle)();
    (0, _video.addVideoPlayer)();
    (0, _audio.addAudioPlayer)();
  });
});
...
},{"./modules/custom/audio":2,"./modules/custom/navigation-toggle":3,"./modules/custom/video":4,"./modules/form-validate/form":6,"./utils/ios-vh-fix":13,"./utils/scroll-lock":14}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addAudioPlayer = void 0;
var addAudioPlayer = function addAudioPlayer() {
  if (document.querySelector('.hero__audio')) {
    var root = document.querySelector('.hero__audio');
    var button = root.querySelector('.hero__audio-play');
...
exports.addNavigationToggle = void 0;
var addNavigationToggle = function addNavigationToggle() {
  var header = document.querySelector('.header');
  var toggle = header.querySelector('[data-navigation-toggle]');
  var navigation = header.querySelector('.header__nav');
...
exports.addVideoPlayer = void 0;
var addVideoPlayer = function addVideoPlayer() {
  if (document.querySelector('.video')) {
    var root = document.querySelector('.video');
    var button = root.querySelector('button');
    var iframe = "\n  <iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/".concat(button.dataset.src, "?autoplay=1\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>\n  ");
    button.addEventListener('click', function () {
      root.innerHTML = iframe;
    }, {
      once: true
